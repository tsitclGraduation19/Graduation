  <?php
print '
   <form action="processAdd.php" method="get">
    <table border="1">
      <tr>
        <th>競技名</th>
    ...
    print
      ...
      if($_REQUEST['type'] == '個人')
      {
        print '<td><label><input type="radio" name="type" value="個人" checked>個人</label>
              <label><input type="radio" name="type" value="団体" disabled>団体</label></td>';
      }
      else
      {
        print '<td><label><input type="radio" name="type" value="個人" disabled>個人</label>
  ...
  print '<th>競技大会</th>';
        ...
        <label><input type="radio" name="olympic" value="パラリンピック" disabled>パラリンピック</label></td>';
        }
else
{
  print '<td><label><input type="radio" name="olympic" value="オリンピック" disabled>オリンピック</label>
    ...
    <label>
      <input type="hidden" value="compe" name="foo">
    </label>
